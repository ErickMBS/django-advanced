...
# Diz em quais IPs o debug_toolbar irá ser apresentado.
...
EMAIL_PORT = 587
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='django.advanced07@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_PSSWD', default='123s1adf56')
EMAIL_USE_TLS = True
